            ...
            <div className="flex flex-col gap-1.5 pt-1">
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                        ...
                        <span className="text-[9px] text-emerald-600 font-medium">手数料最安クラスで両替 (PR)</span>
                    </a>
                    ...
                    >
                        ...
                        <span className="text-[9px] text-indigo-600 font-medium">街歩き中のネット確保 (Airalo)</span>
                    </a>
                </div>
                ...
                <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white p-2.5 rounded-2xl flex flex-col items-center gap-0.5 transition-all text-center shadow-sm"
                >
                    <span className="text-xs font-extrabold flex items-center gap-1">
                        <span>🚗</span> 両替後の移動に：Grab / Bolt 配車アプリ (PR)
                    </span>
                    <span className="text-[9px] text-blue-100 font-medium">高レート両替所からの安全なキャッシュレス移動を事前準備</span>
                </a>
            </div>
