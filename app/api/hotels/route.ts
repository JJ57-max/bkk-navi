...
export async function GET(request: Request) {
  try {
    ...
    // 各ホテルの名称でAgoda内を直接キーワード検索させる安全かつ確実なアフィリエイトリンク
      ...
      hotelsArray = [
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&searchText=${encodeURIComponent('サイアム ケンプンスキー ホテル バンコク')}`,
          dailyRate: 45000,
          currency: 'JPY',
          starRating: 5,
          reviewScore: 9.2,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&searchText=${encodeURIComponent('マリオット ホテル スクンビット')}`,
          dailyRate: 28000,
          currency: 'JPY',
          starRating: 4.5,
          reviewScore: 8.9,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&searchText=${encodeURIComponent('イーステイン グランデ ホテル サトーン')}`,
          dailyRate: 19000,
          currency: 'JPY',
          starRating: 4,
          reviewScore: 9.0,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&searchText=${encodeURIComponent('デュシタニ バンコク')}`,
          dailyRate: 35000,
          currency: 'JPY',
          starRating: 5,
          reviewScore: 9.1,
