...
export async function GET(request: Request) {
  try {
    ...
    // 正しいAgodaのキーワード検索用パラメータ「textToSearch」を用いた個別直リンク
      ...
      hotelsArray = [
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&textToSearch=${encodeURIComponent('サイアム ケンプンスキー ホテル バンコク')}`,
          dailyRate: 45000,
          currency: 'JPY',
          starRating: 5,
          reviewScore: 9.2,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&textToSearch=${encodeURIComponent('マリオット ホテル スクンビット')}`,
          dailyRate: 28000,
          currency: 'JPY',
          starRating: 4.5,
          reviewScore: 8.9,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&textToSearch=${encodeURIComponent('イーステイン グランデ ホテル サトーン')}`,
          dailyRate: 19000,
          currency: 'JPY',
          starRating: 4,
          reviewScore: 9.0,
        ...
        },
        {
          ...
          landingURL: `https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=${AGODA_CONFIG.siteId}&textToSearch=${encodeURIComponent('デュシタニ バンコク')}`,
          dailyRate: 35000,
          currency: 'JPY',
          starRating: 5,
          reviewScore: 9.1,
